        ...
        <div className="text-center space-y-12 animate-slide-up">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto pt-8">
            <Link to="/rentals?type=rental" className="block group">
              <div className="bg-card border-2 border-border hover:border-primary rounded-xl p-8 transition-all duration-300 hover:shadow-xl hover:scale-105">
                ...
                <h3 className="text-2xl font-bold mb-2 group-hover:text-primary transition-colors">Rent</h3>
            ...
            <Link to="/rentals?type=sale" className="block group">
              <div className="bg-card border-2 border-border hover:border-primary rounded-xl p-8 transition-all duration-300 hover:shadow-xl hover:scale-105">
                ...
                <h3 className="text-2xl font-bold mb-2 group-hover:text-primary transition-colors">Buy</h3>
            ...
            <Link to="/services" className="block group">
              <div className="bg-card border-2 border-border hover:border-primary rounded-xl p-8 transition-all duration-300 hover:shadow-xl hover:scale-105">
                ...
                <h3 className="text-2xl font-bold mb-2 group-hover:text-primary transition-colors">Book Service</h3>
