      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card p-8 rounded-lg border">
              <p className="text-lg text-muted-foreground leading-relaxed text-center">
                LocalAuto was founded to solve the frustration of finding reliable automotive services. 
        ...
        <div className="text-center bg-card p-12 rounded-lg border">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied customers who trust LocalAuto for their automotive needs.
          </p>
